...
namespace nanoFramework.Test.Engine
{
	...
	public class AssertFailedException : Exception
	{
		...
		/// <summary>
		///     Initializes a new instance of the <see cref="T:nfUnit.AssertFailedException" /> class that uses with a specified
		///     error message.
		/// </summary>
		...
		/// <summary>
		///     Initializes a new instance of the <see cref="T:nfUnit.AssertFailedException" /> class with a specified error
		///     message and a reference to the inner exception that is the cause of this exception.
		/// </summary>
		/// <param name="message">The error message that explains the reason for the exception.</param>
		/// <param name="exception">
		///     The exception that is the cause of the current exception. If the <paramref name="exception" />
