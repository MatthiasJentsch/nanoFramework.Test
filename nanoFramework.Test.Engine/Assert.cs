...
namespace nanoFramework.Test.Engine
{
	...
	public static class Assert
	{
		...
		public static void AreEqual(object expected, object actual)
		{
			...
			{
				Fail("Assert.AreEqual", expected, actual);
			}
		}
		...
		public static void AreNotEqual(object expected, object actual)
		{
			if (InternalEqual(expected, actual))
			{
				Fail("Assert.AreNotEqual", expected, actual);
			}
		}
		...
		public static void AreSame(object expected, object actual)
		{
			...
			{
				Fail("Assert.AreSame", expected, actual);
			}
		}
		...
		public static void AreNotSame(object expected, object actual)
		{
			if (ReferenceEquals(expected, actual))
			{
				Fail("Assert.AreNotSame", expected, actual);
			}
		}
		...
		private static bool InternalEqual(object expected, object actual)
		{
			...
			if (expectedType.IsValueType && !expectedType.IsEnum && actualType.IsValueType && !actualType.IsEnum)
			{
				...
				switch (expectedType.Name)
				{
					...
					case "Int16": i1 = (short)expected; break;
					case "UInt16": i1 = (ushort)expected; break;
					case "Int32": i1 = (int)expected; break;
					case "UInt32": i1 = (uint)expected; break;
					case "Int64": i1 = (long)expected; break;
					case "UInt64": ui1 = (ulong)expected; break;
					case "Single": d1 = (float)expected; break;
					case "Double": d1 = (double)expected; break;
					case "Boolean": b1 = (bool)expected; break;
					case "Char": c1 = (char)expected; break;
					case "DateTime": dt1 = (DateTime)expected; break;
					case "TimeSpan": tm1 = (TimeSpan)expected; break;
					default: Fail("ASSERT EXCEPTION: Unsupported value type"); break;
				}
				...
				switch (actualType.Name)
				{
					...
					case "Int16": i2 = (short)actual; break;
					case "UInt16": i2 = (ushort)actual; break;
					case "Int32": i2 = (int)actual; break;
					case "UInt32": i2 = (uint)actual; break;
					case "Int64": i2 = (long)actual; break;
					case "UInt64": ui2 = (ulong)actual; break;
					case "Single": d2 = (float)actual; break;
					case "Double": d2 = (double)actual; break;
					case "Boolean": b2 = (bool)actual; break;
